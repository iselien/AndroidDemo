...
public class GradientLayout1 extends View {

    private Paint mPaint;
    private Shader mShader;
    private Bitmap mBitmap;

    public GradientLayout1(Context context) {
        this(context, null);
    }

    public GradientLayout1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GradientLayout1(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        canvas.drawCircle(250, 250, 250, mPaint);
        ...
        mPaint.setShader(mShader);
        canvas.drawCircle(250, 1300, 250, mPaint);
        ...
        mPaint.setShader(mShader);
        canvas.drawCircle(250, 1850, 250, mPaint);
